...
if (isset($_GET['txtname'])) {
    $txtname = htmlspecialchars($_GET['txtname']);
} else {
    $txtname = null;
}

if (isset($_GET['txtmail'])) {
    $txtmail = htmlspecialchars($_GET['txtmail']);
} else {
    $txtmail = null;
}

if (isset($_GET['txtselect'])) {
    $txtselect = htmlspecialchars($_GET['txtselect']);
} else {
    $txtselect = null;
}

$txtvalue = "";
if ($txtselect == "experience") {
    $txtvalue = "見学・体験について";
} else {
    $txtvalue = "イベント出演依頼";
}

if (isset($_GET['txtnaiyou'])) {
    $txtnaiyou = htmlspecialchars($_GET['txtnaiyou']);
} else {
    $txtnaiyou = null;
}
    ...
    <div class="container main-container">
        <main id="main6">
            <div class="midashi-wrapper">
                <h2 class="midashi">お問い合わせ内容確認</h2>
            </div>
            <section>
                <div class="inquiry special01">
                    <div class="bottom">
                        <p class="name">名前</p>
                        <p class="php-get"><?php print $txtname; ?></p>
                    </div>

                    <div class="mail bottom">
                        <p class="mail">メールアドレス</p>
                        <p class="php-get"><?php print $txtmail; ?></p>
                    </div>

                    <div class="bottom">
                        <p class="select">問い合わせ項目</p>
                        <p class="php-get"><?php print $txtvalue; ?></p>
                    </div>

                    <div class="bottom">
                        <p class="naiyou">内容</p>
                        <p class="php-get"><?php print $txtnaiyou; ?></p>
                    </div>

                    <form method="get" action="sendmail.php">
                        <input type="hidden" name="txtname" value="<?php print $txtname; ?>">
                        <input type="hidden" name="txtmail" value="<?php print $txtmail; ?>">
                        <input type="hidden" name="txtselect" value="<?php print $txtselect; ?>">
                        <input type="hidden" name="txtnaiyou" value="<?php print $txtnaiyou; ?>">
                        <p class="display">
